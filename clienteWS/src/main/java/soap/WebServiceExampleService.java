...
public class WebServiceExampleService extends Service {
    ...
    public final static QName SERVICE = new QName("http://soap/", "WebServiceExampleService");
    public final static QName WebServiceExamplePort = new QName("http://soap/", "WebServiceExamplePort");
    static {
        URL url = null;
        try {
